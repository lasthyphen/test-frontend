...
export const REFERENCES: References = {
  ...
  dart: {
    ...
    versions: ['v1', 'v0'],
    icon: '/docs/img/icons/menu/cli-tools.svg',
  },
  cli: {
    name: 'CLI',
    library: undefined,
  ...
  docs: [
    {
      ...
      items: [
        ...
        { name: 'Dijets', url: '/introduction', items: [] },
        { name: 'Platform', url: '/platform', items: [] },
      ],
    },
    {
      label: 'Quickstarts',
    ...
    },
    {
      label: 'Dijets Nodes',
      items: [
        { name: 'Overview', url: '/guides/nodes', items: [] },
        ...
        { name: 'Maintain Dijets Node', url: '/guides/nodes/maintain-dijets-node', items: [] },
        { name: 'Validator Nodes', url: '/guides/nodes/validator-nodes', items: [] },
      ],
    },
    {
      label: 'DijetsJS',
      items: [
        { name: 'Overview', url: '/guides/dijetsjs', items: [] },
        { name: 'Quickstart', url: '/guides/storage/dijetsjs/cdn', items: [] },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Sourcify Verify', url: '/guides/developer-toolchains/verify-smart-contracts-with-sourcify', items: [] },
      ],
    },
    {
      label: 'Platform',
  ...
  reference: [
    {
      ...
      items: [
        ...
        { name: 'Dijets CLI', url: '/reference/cli', items: [] },
