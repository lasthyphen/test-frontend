...
export const functions = {
  ...
  items: [
    { name: 'Issuing API Calls', url: '/guides/api/issuing-api-calls', items: [] },
    { name: 'Method Chain API', url: '/guides/api/method-chain-api', items: [] },
    { name: 'Value Chain API', url: '/guides/api/value-chain-api', items: [] },
    { name: 'Utility Chain API', url: '/guides/api/utility-chain-api', items: [] },
    { name: 'Admin API', url: '/guides/api/admin-api', items: [] },
    { name: 'Authentication API', url: '/guides/api/auth-api', items: [] },
    { name: 'Healthcheck API', url: '/guides/api/health-api', items: [] },
    { name: 'Index API', url: '/guides/api/index--api', items: [] },
    { name: 'Keystore API', url: '/guides/api/keystore-api', items: [] },
    { name: 'Info API', url: '/guides/api/info-api', items: [] },
    { name: 'IPC API', url: '/guides/api/ipc-api', items: [] },
    { name: 'Metrics API', url: '/guides/api/metrics-api', items: [] },
  ],
}
...
items: [
  { name: 'Staking & Delegations', url: '/guides/nodes/run-dijets-node-with-installer-script', items: [] },
  { name: 'Adding a Validator', url: '/guides/nodes/run-dijets-node-manually', items: [] },
],
},
  ],
}
...
export const storage = {
  ...
  url: '/guides/dijetsjs',
  items: [
    { name: 'Dijets Overview', url: '/guides/dijetsjs', items: [] },
    { name: 'Quickstart', url: '/guides/dijetsjs/cdn', items: [] },
    { name: 'Access Control', url: '/guides/dijetsjs/access-control', items: [] },
    { name: 'CDN', url: '/guides/dijetsjs/cdn', items: [] },
    { name: 'Image Transformations', url: '/guides/dijetsjs/image-transformations', items: [] },
  ],
}

export const dijetsjs = {
  title: 'DijetsJS',
  icon: 'dijetsjs',
  label: 'DijetsJs',
  url: '/guides/dijetsjs',
