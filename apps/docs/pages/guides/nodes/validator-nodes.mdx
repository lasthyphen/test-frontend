...
Calling
[`platform.getPendingValidators`](/docs/node-apis/method-chain-api#platformgetpendingvalidators)
...
You can also call
[`platform.getCurrentValidators`](/docs/node-apis/method-chain-api#platformgetpendingvalidators)
