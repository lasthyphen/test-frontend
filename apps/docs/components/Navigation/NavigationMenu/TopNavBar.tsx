      ...
      <div className="max-w-[1400px] grid grid-cols-12 mx-auto gap-4 px-5 h-full">
        ...
        <div className="col-span-4 flex items-center justify-end gap-3">
          <Button
            ...
            className="relative cursor-pointer inline-flex items-center space-x-2 text-center font-regular transition ease-out duration-200 rounded outline-none transition-all outline-0 focus-visible:outline-4 focus-visible:outline-offset-1 bg-brand-fixed-1100 hover:bg-brand-fixed-1000 text-scale-100 bordershadow-brand-fixed-1000 hover:bordershadow-brand-fixed-900 dark:bordershadow-brand-fixed-1000 dark:hover:bordershadow-brand-fixed-1000 focus-visible:outline-brand-600 shadow-sm text-xs px-2.5 py-1 hidden text-scale-100 lg:block"
            target="_blank"
