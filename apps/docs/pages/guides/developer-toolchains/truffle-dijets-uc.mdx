...
[DijetsJS](/docs/guides/dijetsjs) which is used for cross chain
swaps.
...
You'll to have a minimum of `0.15` DJTX unlocked in your account to cover the cost
...
[Utility Chain Configs](/docs/guides/node-flags-configs#utility-chain-configs).
