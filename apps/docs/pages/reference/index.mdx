...
Reference documentation for the official Dijets client libraries, APIs, and tools.
  ...
  <div className="grid grid-cols-2 gap-3">
    ...
    <div>
      <ButtonCard icon="/docs/img/icons/cli-icon.svg"
        to="/reference/cli"
        title="Dijets CLI"
        description="Tools for developing your Dijets projects locally."
      />
    </div>
    <div>
      <ButtonCard icon="/docs/img/icons/api-icon.svg"
        ...
        description="Manage your Dijets projects programmatically." />
    </div>
...
Reference documentation for self-hosting Dijets features.
